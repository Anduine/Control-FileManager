...
namespace ControlFileManager.UI.Views
{
    public partial class FilePanelView : UserControl
    {
        ...
        private void RenameRequested(object sender, EventArgs e)
        {
